<template>
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="(order, index) in data.records" :key="order.id">
          <thead>
          <tr>
            <th colspan="5">
      ...
      <div class="choose-order">
        <Pagination :pageNo="page" :pageSize="limit" :total="data.total" :continues="5"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
  ...
  methods: {
    async getMyOrder() {
      let result = await this.$API.reqMyOrder()
      if (result.code == 200) {
