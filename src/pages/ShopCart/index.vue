<template>
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart, index) in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con2">
            <img :src="cart.imgUrl">
            <div class="item-msg hyperlink" @click="goDetail">{{ cart.skuName }}</div>
          </li>
          ...
          <li class="cart-list-con7">
            <a class="hyperlink" @click="deleteGood(cart)">删除</a>
            <br>
            <a class="hyperlink">移到收藏</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="cart-tool">
      ...
      <div class="option">
        <a class="hyperlink">删除选中的商品</a>
        <a class="hyperlink">移到我的关注</a>
        <a class="hyperlink">清除下柜商品</a>
      </div>
      <div class="money-box">
...
export default {
  ...
  methods: {
    ...
    handler: throttle(async function (type, disNum, cart) {
      // 注意：接口要求传递差值而非变化量，如传递1表示在原来的基础上+1，传递-1表示减1
      switch (type) {
        case 'plus':
          disNum = 1
          break
