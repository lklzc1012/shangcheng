  ...
  <div class="pay-main">
    <div class="pay-container">
      ...
      <div class="checkout-info">
        <h4>重要提示：</h4>
        <ol>
          <li>商城支付平台目前支持<span class="zfb">支付宝、微信</span>支付方式。</li>
          <li>其它支付渠道敬请期待。</li>
          <li>为了保证您的购物支付流程顺利完成，请阅读以下信息。</li>
        </ol>
        <h4>重要提示：</h4>
        <ul>
          <li>商城支付平台目前支持<span class="zfb">支付宝、微信</span>支付方式。</li>
      ...
      <div class="checkout-steps">
        ...
        <div class="hr"></div>
        <div class="submit">
          <a class="btn hyperlink" @click="open">立即支付</a>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    ...
    async open() {
      ...
      this.$alert(`<img src=${url} />`, '请使用微信支付', {
        ...
        showClose: false,
        // action: 按钮类型 instance: 当前组件实例 done: 关闭弹窗
