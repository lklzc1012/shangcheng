<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(order, index) in cartInfoList" :key="order.skuId">
          <li>
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        电话：<span>{{ userDefaultAddress.phoneNum }}</span>
      </div>
    </div>
    <div class="sub clearFix">
      <a class="subBtn hyperlink" @click="submitOrder">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    this.totalNum = this.cartInfoList[0].totalNum
    this.totalAmount = this.cartInfoList[0].totalAmount
  },
  computed: {
    ...mapState({
      addressList: state => state.Trade.userAddressList,
    }),
    ...mapGetters(['cartList']),
    cartInfoList() {
  ...
  methods: {
    ...
    submitOrder() {
      this.$router.push(`/pay?orderId=90aa16f24d04c7d882051412f9ec45b`)
    }
  }
}
</script>
